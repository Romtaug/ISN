...
# --------------------------------------------------------#
#               ISN BaccalaurÃ©at 2019 - LycÃ©e Vernant   #
#                            Fantatosy                    #
# --------------------------------------------------------#
...
root=Tk()
#Décors
victoire_image=PhotoImage(file="victoire.png")
...
aimer_image=PhotoImage(file="reticle.png")
...
chev1_image=PhotoImage(file="chevalier.gif")
chev2_image=PhotoImage(file="chevalier1.gif")
...
wave3_image=PhotoImage(file="wave3.png")
...
chev1=frame.create_image(0,height1-60,image=chev1_image)
chev2=frame.create_image(0,height1-60,image=chev1_image)
chev3=frame.create_image(0,height1-60,image=chev1_image)
chev1d=frame.create_image(1060,height1-60,image=chev2_image)
chev2d=frame.create_image(1060,height1-60,image=chev2_image)
chev3d=frame.create_image(1060,height1-60,image=chev2_image)

layer1=frame.create_image(width1/2,height1/2,image=background)

#Définition des boulets
...
#Définition du menu et position
aimer=frame.create_image(0,0,image=aimer_image)
menu=frame.create_image(518,225,image=menu_image)
wave1=frame.create_image(380,-29,image=wave1_image)
exito=frame.create_image(456,-29,image=exit_image)
wave2=frame.create_image(304,-29,image=wave2_image)
wave3=frame.create_image(228,-29,image=wave3_image)
...
def cannon_shoot_coords(event):
    '''calcul le déplacement par image du boulet pour une
direction et un sens détèrminé par les coordonnées d'un clic gauche sur la map'''
    global can_shoot_R,can_shoot_L
    global vitessel_x
    global vitessel_y
    global vitesser_x
    global vitesser_y
...
def test1(event):
    global wave_1
    # Ajout bruitage    
    winsound.PlaySound("attaque.wav", winsound.SND_FILENAME) 
...
#Définition du tir des boulets
def menuclick(event):
    '''déplace les menus apres un clic sur le bouton pause/arret'''
...
#Réapparition des boulets
def reset_bullet(objeto):
    '''prend un boulet et calcul le deplacement pour que le boulet revient derriere
le canon et arrete le mouvement du boulet'''
    global cycle_r,cycle_l,cycle_r_old,cycle_l_old
    global active_l1,active_l2,active_l3,active_l4
    global active_r1,active_r2,active_r3,active_r4
    global bullet_l1,bullet_l2,bullet_l3,bullet_l4
    global bullet_r1,bullet_r2,bullet_r3,bullet_r4
...
def bullet(vitesser_x,vitesser_y,vitessel_x,vitessel_y):
    '''applique la vitesse calculé par cannon_shoot_coords() au boulets et prend
    le cycle de la fonction cycle() pour donner a chaque clic ghauche un boulet
    à tirer et regarde si il y a eut collision des boulets avec un objet avec la fonction
    hibox()'''

    global cycle_r,cycle_l,cycle_r_old,cycle_l_old
    global active_l1,active_l2,active_l3,active_l4
    global active_r1,active_r2,active_r3,active_r4
    global vitesse_r1_x,vitesse_r1_y,vitesse_r2_x,vitesse_r2_y,vitesse_r3_x,vitesse_r3_y,vitesse_r4_x,vitesse_r4_y
    global vitesse_l1_x,vitesse_l1_y,vitesse_l2_x,vitesse_l2_y,vitesse_l3_x,vitesse_l3_y,vitesse_l4_x,vitesse_l4_y
    global bullet_l1,bullet_l2,bullet_l3,bullet_l4
    global bullet_r1,bullet_r2,bullet_r3,bullet_r4
...
#Rotation des canons
def cannon_rotation():
    '''calcul l'angle de rotation du cannon en et fait tourner ''' 
...
#Cycle des boulets
def cycle(event):
    '''fait un cycle entre les differents boulets de cannon ,pour que le joueur ait un boulet a tirer'''
    global can_shoot_R,can_shoot_L
...
#Contact boulets avec l'ennemi
def hitboxes(obiectum):
    '''regarde si il y a eut une collision dans le carre de 4*4 pixels
    si il y a eut collision alors on remet le boulet dans sa postion intiital et on
    fait prendre des degats au monstre en question'''
    x1,y1=frame.coords(obiectum)
    #liste avec les elements qui sont en contact avec l'objet
    OC=[]
...
#Explosion boulets
def hit(x1,y1):
    '''joue une animation d'explosion sur le coordonnees de la collision'''
    global active_boom,boom
    boom=frame.create_image(x1+2,y1+2,image=boom_image)
    booms.append(boom)
    active_boom=1

#Réanimation ennemies
def reset_mob(mob):
    '''Remet les points de vie de tous les personnages a leurs etat initial,
    les bouge au point de depart hors de l'ecran et arrete le mouvement'''
    global active_gob1,active_gob2,active_gob3,active_gob4,active_gob5,active_gob6
    global active_gol1,active_gol2,active_gol3
    global active_skel1,active_skel2,active_skel3,active_skel4
    global active_skel5,active_skel6,active_skel7,active_skel8
    global active_skull1,active_skull2,active_skull3,active_skull4
    global gob1_health,gob2_health,gob3_health,gob4_health,gob5_health,gob6_health
    global gol1_health,gol2_health,gol3_health
    global skel1_health,skel2_health,skel3_health,skel4_health
    global skel5_health,skel6_health,skel7_health,skel8_health
    global skull1_health,skull2_health,skull3_health,skull4_health
    global active_chev1,active_chev2,active_chev3,active_chev1d,active_chev2d,active_chev3d
    global chev1_health,chev2_health,chev3_health,chev1d_health,chev2d_health,chev3d_health
...
#Contact des ennemies avec la tour
def tower():
    '''regarde si il ya a eut contact avec la tour, si contact on remet le mob au 
 point de depart et on perd des points de vie en accord'''
    global tower_health
    OC=[]
...
#Perte vie tour en fonction des ennemies 
def health():
    '''Prend en charge le nombre de coeur qui apparait au-dessus de la tour
    en fontion des points de vie restant'''
    global tower_health
    ...
    if tower_health <= 0:
        frame.move(heart1,0,500)
        frame.move(heart2,0,500)
        frame.move(heart3,0,500)
        frame.move(heart4,0,500)
        lost=frame.create_image(width1/2,height1/2,image=game_over)
        # Ajout bruitage    
        winsound.PlaySound("perdu.wav", winsound.SND_FILENAME) 

#Vie nouvelle vague
def reset_game():
    x1,y1=frame.coords(heart1)
    x2,y2=frame.coords(heart2)
    x3,y3=frame.coords(heart3)
    x4,y4=frame.coords(heart4)
    frame.move(heart1,0,45-y1)
    frame.move(heart2,0,45-y2)
    frame.move(heart3,0,45-y3)
    frame.move(heart4,0,45-y4)

def goblin(goblino):
    '''s'occupe des PV de monstres de types goblin
    et les stop avec la fonction reset_mob'''
    global gob1_health,gob2_health,gob3_health,gob4_health,gob5_health,gob6_health
    if goblino==goblin1:
...
def golem(golemo):
    '''s'occupe des PV de monstres de types golems
    et les stop avec la fonction reset_mob'''
    global gol1_health,gol2_health,gol3_health
    if golemo==golem1:
...
def skeleton(skeletono):
    '''s'occupe des PV de monstres de types skeleton
    et les stop avec la fonction reset_mob'''
    global skel1_health,skel2_health,skel3_health,skel4_health
    global skel5_health,skel6_health,skel7_health,skel8_health
...
def skull(skullo):
    '''s'occupe des PV de monstres de types skull
    et les stop avec la fonction reset_mob'''
    global skull1_health,skull2_health,skull3_health,skull4_health
    if skullo==skull1:
...
def other(othero):
    '''s'occupe des PV de monstres de types golems
    et les stop avec la fonction reset_mob'''
    global chev1_health,chev2_health,chev3_health
    global chev1d_health,chev2d_health,chev3d_health
    if othero==chev1:
...
#Vitesse des ennemies
def animation():
    '''gere la vitesse de mouvement des monstres tout en soccupant
    de lanimation des GIFS'''
    global active_gob1,active_gob2,active_gob3,active_gob4,active_gob5,active_gob6
    global active_gol1,active_gol2,active_gol3
    global active_skel1,active_skel2,active_skel3,active_skel4
    global active_skel5,active_skel6,active_skel7,active_skel8
    global active_skull1,active_skull2,active_skull3,active_skull4
    global counter_skeleton1,counter_skeleton2,counter_skeleton3,counter_skeleton4
    global counter_skeleton5,counter_skeleton6,counter_skeleton7,counter_skeleton8
    global frame_skeleton1,frame_skeleton2,frame_skeleton3,frame_skeleton4
    global frame_skeleton5,frame_skeleton6,frame_skeleton7,frame_skeleton8
    global counter_skull1,counter_skull2,counter_skull3,counter_skull4
    global frame_skull1,frame_skull2,frame_skull3,frame_skull4
    global counter_golem1,counter_golem2,counter_golem3
    global frame_golem1,frame_golem2,frame_golem3
    global frame_goblin1,frame_golbin2,frame_golbin3
    global frame_golbin4,frame_golbin5,frame_golbin6
    global active_boom,frame_boom
    global active_chev1,active_chev2,active_chev3
    global active_chev1d,active_chev2d,active_chev3d
    global counter_chev1,counter_chev2,counter_chev3
    global counter_chev1d,counter_chev2d,counter_chev3d
    ...
    if active_chev1==1:
        frame_counter(chev1)
        i=str(frame_chev1)
        chev1_image.configure(format="gif -index "+i)
        frame.move(chev1,2,0)
    if active_chev2==1:
        frame_counter(chev2)
        i=str(frame_chev2)
        chev1_image.configure(format="gif -index "+i)
        frame.move(chev2,2,0)
    if active_chev3==1:
        frame_counter(chev3)
        i=str(frame_chev3)
        chev1_image.configure(format="gif -index "+i)
        frame.move(chev3,2,0)
    if active_chev1d==1:
        frame_counter(chev1d)
        i=str(frame_chev1d)
        chev2_image.configure(format="gif -index "+i)
        frame.move(chev1d,-2,0)
    if active_chev2d==1:
        frame_counter(chev2d)
        i=str(frame_chev2d)
        chev2_image.configure(format="gif -index "+i)
        frame.move(chev2d,-2,0)
    if active_chev3d==1:
        frame_counter(chev3d)
        i=str(frame_chev3d)
        chev2_image.configure(format="gif -index "+i)
        frame.move(chev3d,-2,0)
    if active_gol1==1:
...
def frame_counter(mob):
    '''compteur du cycle des frames pour lanimation'''
    global counter_golem1,counter_golem2,counter_golem3
    global frame_golem1,frame_golem2,frame_golem3
    global frame_goblin1,frame_goblin2,frame_goblin3
    global frame_goblin4,frame_goblin5,frame_goblin6
    global counter_skeleton1,counter_skeleton2,counter_skeleton3,counter_skeleton4
    global counter_skeleton5,counter_skeleton6,counter_skeleton7,counter_skeleton8
    global frame_skeleton1,frame_skeleton2,frame_skeleton3,frame_skeleton4
    global frame_skeleton5,frame_skeleton6,frame_skeleton7,frame_skeleton8
    ...
    global counter_chev1,counter_chev2,counter_chev3
    global counter_chev1d,counter_chev2d,counter_chev3d
    global frame_chev1,frame_chev2,frame_chev3
    global frame_chev1d,frame_chev2d,frame_chev3d
    ...
    if mob==skull4:
        ...
        if frame_skull4==9:
            frame_skull4=0
    if mob==chev1:
        frame_chev1=frame_chev1+1
        if frame_chev1==4:
            frame_chev1=0
    if mob==chev2:
        frame_chev2=frame_chev2+1
        if frame_chev2==4:
            frame_chev2=0
    if mob==chev3:
        ...
        if frame_chev3==4:
            frame_chev3=0
    if mob==chev1d:
        frame_chev1d=frame_chev1d+1
        if frame_chev1d==4:
            frame_chev1d=0
    if mob==chev2d:
        frame_chev2d=frame_chev2d+1
        if frame_chev2d==4:
            frame_chev2d=0
    if mob==chev3d:
...
def viseur(event):
    x=event.x
    y=event.y
    x1,y1=frame.coords(aimer)
    frame.move(aimer,x-x1,y-y1)
    
def level_1():
    '''active les monstres en fonction du temps ecoule <=> faire les niveaux'''
    global active_gob1,active_gob2,active_gob3
    global active_gob4,active_gob5,active_gob6
    global active_gol1,active_gol2,active_gol3
    global active_skel1,active_skel2,active_skel3,active_skel4
    global active_skel5,active_skel6,active_skel7,active_skel8
    global active_skull1,active_skull2,active_skull3,active_skull4
    ...
    if wave_1==1:
        ...
        if timer>600:
            time=0
            if active_gol2==0:
                victoire=frame.create_image(width1/2,height1/2,image=victoire_image)
                time=timer
                # Ajout bruitage    
                winsound.PlaySound("applause.wav", winsound.SND_FILENAME)
            if time+150==timer:
                frame.delete(victoire)
                wave1=0
                timer=0
...
counter_chev1,counter_chev2,counter_chev3,counter_chev1d,counter_chev2d,counter_chev3d=0,0,0,0,0,0
frame_chev1,frame_chev2,frame_chev3,frame_chev1d,frame_chev2d,frame_chev3d=0,0,0,0,0,0
...
active_chev1,active_chev2,active_chev3,active_chev1d,active_chev2d,active_chev3d=0,0,0,0,0,0
chev1_health,chev2_health,chev3_health,chev1d_health,chev2d_health,chev3d_health=2,2,2,2,2,2
gol1_health,gol2_health,gol3_health,=10,10,10
active_boom=0
can_shoot_R,can_shoot_L=1,1
counter_r,counter_l=0,0
frame_boom=0
boom1=0
booms=[]
...
try:
    ...
    while playing==1:
        ...
        frame.tag_bind(wave3,"<Button 1>",test3)
