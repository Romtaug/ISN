...
chev1d=frame.create_image(1060,height1-55,image=chev2_image)
chev2d=frame.create_image(1060,height1-55,image=chev2_image)
chev3d=frame.create_image(1060,height1-55,image=chev2_image)
...
def tower():
    '''regarde si il ya a eut contact avec la tour, si contact on remet
le mob au point de départ et on perd des points de vie en accord'''
    global tower_health
    OC=[]
...
def goblin(goblino):
    '''s'occupe des PV de monstres de types goblin et les stop avec la fonction
    reset_mob'''
...
def golem(golemo):
    '''s'occupe des PV de monstres de types golems et les
stop avec la fonction reset_mob'''
...
def skeleton(skeletono):
    '''s'occupe des PV de monstres de types skeleton et les
stop avec la fonction reset_mob'''
...
def skull(skullo):
    '''s'occupe des PV de monstres de types skull et les
stop avec la fonction reset_mob'''
...
def other(othero):
    '''s'occupe des PV de monstres de types chevaliers et les
stop avec la fonction reset_mob'''
...
def animation():
    ...
    global active_chev1,active_chev2,active_chev3,active_chev1d,active_chev2d,active_chev3d
    global counter_chev1,counter_chev2,counter_chev3,counter_chev1d,counter_chev2d,counter_chev3d
...
active_chev1,active_chev2,active_chev3,active_chev1d,active_chev2d,active_chev3d=3,3,3,3,3,3
...
try:
    ...
    while playing==1:
        ...
        frame.tag_bind(wave2,"<Button 1>",test3)
